...
class _GithubApi implements GithubApi {
  ...
  @override
  Future<IssueResult> getIssues(query) async {
  ...
  Future<List<PullRequests>> getPullRequests(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<List<dynamic>>(_setStreamType<List<PullRequests>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    var value = _result.data!
        .map((dynamic i) => PullRequests.fromJson(i as Map<String, dynamic>))
        .toList();
    return value;
  }
